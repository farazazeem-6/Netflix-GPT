  ...
  return (
    <div className="w-full h-screen absolute top-0 left-0 flex flex-col justify-center px-4 sm:px-8 md:px-12 text-white bg-linear-to-r from-black via-black/50 to-transparent">
      ...
      <div className="flex gap-2 sm:gap-3 md:gap-4">
        ...
        <button className="bg-gray-500 bg-opacity-70 py-1.5 sm:py-2 px-4 sm:px-5 md:px-6 text-white text-sm sm:text-base font-semibold cursor-pointer rounded hover:bg-opacity-50 flex items-center gap-1 sm:gap-2">
