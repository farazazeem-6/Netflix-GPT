  ...
  return (
    <div className="flex justify-center pt-[10%]">
      <form className="bg-black w-1/2 grid grid-cols-12 rounded-2xl" onSubmit={(e)=>e.preventDefault()}>
        ...
        />
        <button onClick={handleGptSearch} className="bg-red-700 text-white text-sm font-semibold rounded-lg py-2 px-4 col-span-3 m-4 cursor-pointer hover:bg-red-800">
